  ...
  try {
    ...
    const config = await prisma.interventionConfig.create({
      data: {
        ...
        conformityResults: existingConfig.conformityResults as any,
        conditionalFields: existingConfig.conditionalFields as any,
        validations: existingConfig.validations as any,
        createdById: req.user!.userId,
      },
      include: {
        createdBy: {
